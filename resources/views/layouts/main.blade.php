        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="../../index.html">
              ...
              <span class="menu-title">Employ Management</span>
            </a>
          </li>


          <li class="nav-item menu-items">
            <a class="nav-link" data-bs-toggle="collapse" href="#collapseSystem" aria-expanded="false" aria-controls="collapseSystem">
              <span class="menu-icon">
            ...
            <div class="collapse" id="collapseSystem">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="../../pages/ui-features/buttons.html">Country</a></li>
                <li class="nav-item"> <a class="nav-link" href="../../pages/ui-features/dropdowns.html">State</a></li>
                <li class="nav-item"> <a class="nav-link" href="../../pages/ui-features/typography.html">Department</a></li>
                <li class="nav-item"> <a class="nav-link" href="../../pages/ui-features/typography.html">City</a></li>
              </ul>
            </div>
          </li>

          <li class="nav-item menu-items">
            <a class="nav-link" data-bs-toggle="collapse" href="#collapseUser" aria-expanded="false" aria-controls="collapseUser">
              <span class="menu-icon">
                <i class="mdi mdi-laptop"></i>
              </span>
              <span class="menu-title">System Management</span>
            ...
            <div class="collapse" id="collapseUser">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="../../pages/ui-features/dropdowns.html">Role</a></li>
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="profileDropdown">
                  ...
                  <a class="dropdown-item" href="{{ route('logout') }}"
                    ...
                    <div class="preview-item-content">
                      <p class="preview-subject mb-1">{{ __('Logout') }}
